...
<head>
<meta charset="utf-8">
<title>普通工单 全量回归总览 {date_str}</title>
...
<div class="card">
  <div style="padding:20px 24px">
    <h1 style="font-size:20px;font-weight:700;margin-bottom:4px">普通工单 全量回归总览</h1>
...
out = os.path.join(ROOT, "docs", "reports", f"普通工单-全量回归总览-{date_str}.html")
